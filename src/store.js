  ...
  projects: [
    {
      ...
      for: ` This is for: People who love text-based games.`,
      why: `Why: Originally as a school project, but largely out of a desire to build a game.`,
    ...
    },
    {
      ...
      for: `This is for: People who play the lotto. `,
      why: `Why: People like to use special numbers in lotto, but don't care about any remaining numbers they need to fill out.`,
...

    {
      ...
      desc: `I am currently working on modifying a classic WoW server and client to implement some custom content.\n
       This has become a major consumer of my time, but it is also giving me a ton of experience in reading and understanding an existing codebase.\n
      ...
      for: `This is for: Mostly myself and friends.`,
      why: `Why: For fun, and to learn how the systems I enjoy are created.`,
...

    {
      ...
      desc: `An app where users can go to in order to create custom characters in custom races, classes, time periods, or what have you.\n
       Once on the site, you can log in using the credentials listed in the README in the GitHub repo.
      ...
      for: `This is for: People looking  to manage character sheets in tabletop RPGs.`,
      why: `Why: As a school project, but for myself to manage characters as well.`,
